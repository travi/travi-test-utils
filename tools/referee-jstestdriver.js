(function (window, undefined) {
        ...
        function createEventEmitter(object) {
            ...
            object.on = function (event, listener, thisp) {
                if (typeof event === "function") {
                    return supervisors(this).push({ listener: event, thisp: listener });
                }
    ...
    window.referee.samsam = samsam;

    var formatio = (function () {
        "use strict";
        ...
        formatio.functionName = functionName;
        formatio.constructorName = constructorName;
        formatio.ascii = ascii;
        return formatio;
    }());
    ...
    // Use to format things nicely
    var logFormatter = create(formatio);
    ...
    // Assertion counting
    jstestdriver.assertCount = jstestdriver.assertCount || 0;
    var count = function () { jstestdriver.assertCount++; };
    referee.on("pass", count);
    referee.on("failure", count);

    // Override jstestdriver's console logger
    var logger = jstestdriver.console.log;
    jstestdriver.console.log = function () {
        return logger.call(this, asciiFormat.apply(this, arguments));
    };

    // Sinon assertions
    (function () {
        if (typeof sinon === "undefined") { return; }
        ...
        sinon.format = asciiFormat;

        // Sinon assertions for referee
        ...
        referee.add("callOrder", {
            assert: function (spy) {
                var args = _.isArray(spy) ? spy : arguments;
        ...
        referee.add("calledWithMatch", {
            ...
            assertMessage: "Expected ${0} to be called with matching arguments ${1}${2}",
            refuteMessage: "Expected ${0} not to be called with matching arguments${1}${2}",
            expectation: "toHaveAlwaysBeenCalledWithExactly",
            values: spyAndCalls
        });
        ...
        referee.add("alwaysCalledWithMatch", {
            ...
            assertMessage: "Expected ${0} to always be called with matching arguments ${1}${2}",
            refuteMessage: "Expected ${0} not to always be called with matching arguments${1}${2}",
            expectation: "toHaveAlwaysBeenCalledWithExactly",
            values: spyAndCalls
        });
